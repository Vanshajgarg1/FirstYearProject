...
class Score:
    ...
    def show(self):
        self.lbl = self.font.render(f'HI {self.hs} {self.act}', True, self.color)
...
class Game:
    ...
    def set_labels(self):
        ...
        self.big_lbl = big_font.render(f'G A M E  O V E R', True, (0, 0, 0))
        self.small_lbl = small_font.render(f'press r to restart', True, (0, 0, 0))
